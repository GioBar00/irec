...
cp bin/bench bench_bin/ubpf_bw_irie_bench
cp bin/rac bench_bin/ubpf_bw_irie_rac
...
tar -kxf bazel-bin/scion.tar -C bin
tar -kxf bazel-bin/scion-ci.tar -C bin
cp bin/bench bench_bin/ubpfjit_bw_irie_bench
cp bin/rac bench_bin/ubpfjit_bw_irie_rac
...
tar -kxf bazel-bin/scion.tar -C bin
tar -kxf bazel-bin/scion-ci.tar -C bin
cp bin/bench bench_bin/wa_bw_irie_bench
cp bin/rac bench_bin/wa_bw_irie_rac
...
tar -kxf bazel-bin/scion.tar -C bin
tar -kxf bazel-bin/scion-ci.tar -C bin
cp bin/bench bench_bin/waopt_bw_irie_bench
cp bin/rac bench_bin/waopt_bw_irie_rac
...
tar -kxf bazel-bin/scion.tar -C bin
tar -kxf bazel-bin/scion-ci.tar -C bin
cp bin/bench bench_bin/native_bw_irie_bench
cp bin/rac bench_bin/native_bw_irie_rac

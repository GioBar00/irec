...
type IngressStore interface {
	GetBeacons(ctx context.Context, req *cppb.BeaconQuery) ([]*cppb.IRECBeaconUnopt, []int64, error)
...
type DB interface {
	...
	GetBeacons(ctx context.Context, opts *beacon2.QueryOptions) ([]*cppb.IRECBeaconUnopt, []int64, error)
	GetBeaconsByRowIDs(ctx context.Context, ids []int64) ([]*cppb.EgressBeacon, error)
	GetBeaconByRowID(ctx context.Context, id int64) (*cppb.EgressBeacon, error)
...
func (s *baseStore) GetBeacons(ctx context.Context, req *cppb.BeaconQuery) ([]*cppb.IRECBeaconUnopt, []int64, error) {

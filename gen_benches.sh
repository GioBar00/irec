...
#cp bin/bench bench_bin/ubpf_thr_ire_bench
#cp bin/rac bench_bin/ubpf_thr_ire_rac
#
## UBPF JIT
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/ubpfjit_thr_ire_bench
#cp bin/rac bench_bin/ubpfjit_thr_ire_rac
#
## WASM
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/wa_thr_ire_bench
#cp bin/rac bench_bin/wa_thr_ire_rac
#
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/waopt_thr_ire_bench
#cp bin/rac bench_bin/waopt_thr_ire_rac
##
## NATIVE
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/native_thr_ire_bench
#cp bin/rac bench_bin/native_thr_ire_rac
#
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/ubpf_lat_ire_bench
#cp bin/rac bench_bin/ubpf_lat_ire_rac
...
tar -kxf bazel-bin/scion.tar -C bin
tar -kxf bazel-bin/scion-ci.tar -C bin
cp bin/bench bench_bin/ubpfjit_lat_ire_bench
cp bin/rac bench_bin/ubpfjit_lat_ire_rac
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/wa_lat_ire_bench
#cp bin/rac bench_bin/wa_lat_ire_rac
#
## WASM OPTIMIZATIONS STRIPPED
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/waopt_lat_ire_bench
#cp bin/rac bench_bin/waopt_lat_ire_rac
#
## NATIVE
...
#tar -kxf bazel-bin/scion.tar -C bin
#tar -kxf bazel-bin/scion-ci.tar -C bin
#cp bin/bench bench_bin/native_lat_ire_bench
#cp bin/rac bench_bin/native_lat_ire_rac
